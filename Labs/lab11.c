...
int main()
{
    ...
    while (i < 6){
        ...
        if(Q == 3){
            ...
            printf("\nВведите кординаты C:");
            scanf("%f %f",&Cx,&Cy);
            float s1 = sqrt((Bx - Ax)*(Bx - Ax) + (By - Ay)*(By - Ay));
            float s2 = sqrt((Cx - Ax)*(Cx - Ax) + (Cy - Ay)*(Cy - Ay));
            if(s2>s1){
                printf("Ближе находится точка B. Растояние равно = %f\n",s1);    
            }
            else{printf("Ближе находится точка C. Растояние равно = %f\n",s2);}
            printf("/////////////////////////////////////////////////////////////////\n");
        }
        if(Q == 4){
            int x=0,y=0;
